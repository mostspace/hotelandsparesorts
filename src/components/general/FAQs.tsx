        ...
        <div className="w-full flex md:flex-row flex-col items-stretch bg-light border border-accent/30">
            ...
            <Accordion type="single" collapsible className="w-full mx-auto">
                <AccordionItem value="q1">
                    <AccordionTrigger>I have a Hotel & Spa Resorts gift voucher, how do I redeem it?</AccordionTrigger>
                ...
                <AccordionItem value="q2">
                    <AccordionTrigger>Can I present the gift voucher at a hotel at check in or check out?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="q3">
                    <AccordionTrigger>My stay costs more than the value of my gift voucher, can I pay the balance with my card?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="q4">
                    <AccordionTrigger>My stay costs less than the value of my gift voucher, will the balance stay on my voucher?</AccordionTrigger>
                    <AccordionContent>
