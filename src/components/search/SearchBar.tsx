...
export const SearchBar = (props:SearchBarProps) => {
    ...
    <div ref={rootRef} className="w-full flex flex-row gap-4 text-primary justify-center z-10">
        ...
        {props.showLocation && <div className={`flex flex-row gap-3 bg-light px-[20px] py-[10px] w-[30%] items-center ${props.showBorders?"border border-primary":""} rounded-lg`} onClick={()=>openPicker("")}>
        ...
        {!props.showLocation && <div className={`relative flex flex-col gap-1 items-start text-base  bg-light px-[20px] py-[10px] w-[30%] cursor-pointer ${props.showBorders?"border border-primary":""} rounded-lg`}  onClick={()=>openPicker("checkin")}>
        ...
        <div className={`relative flex flex-row gap-3 bg-light px-[20px] py-[10px] w-[30%] ${props.showBorders?"border border-primary":""} rounded-lg`}>
