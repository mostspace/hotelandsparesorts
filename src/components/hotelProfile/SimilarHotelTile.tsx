...
export const SimilarHotelTile = (props:HotelTileProps) => {
    ...
    return(
        <div className="relative flex flex-col items-start h-[543px] lg:w-[486px] pb-[40px] gap-5 bg-light cursor-pointer rounded-lg overflow-hidden" onClick={()=>openHotel(props.hotel.hid)} >
