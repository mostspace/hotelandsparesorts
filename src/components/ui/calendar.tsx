...
function CalendarDayButton({ className, day, modifiers, ...props }: React.ComponentProps<typeof DayButton>) {
  ...
  return (
    <Button
      ...
      data-focused={modifiers.focused} // <-- key fix: maps DayPicker focus to DOM for hover/focus styles
      className={cn(
        // single selected day
        ...
        "flex aspect-square w-full min-w-(--cell-size) flex-col gap-1 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px]",
