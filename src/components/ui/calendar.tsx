...
function Calendar({
  ...
  return (
    <DayPicker
      autoFocus={false} // don't rely on automatic focus
      ...
      classNames={{
        ...
        dropdown_root: cn("relative border border-input shadow-xs rounded-md", defaultClassNames.dropdown_root),
...
function CalendarDayButton({
  ...
  // Stable focus management after hydration
  React.useEffect(() => {
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "flex aspect-square w-full flex-col gap-1 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px]",
