    ...
    return <div className="w-full flex flex-col items-start gap-5.5 px-5 md:px-[182px] py-[6px] text-base font-medium bg-light">
        ...
        <div className="w-full flex flex-row justify-between">
            <div className="flex flex-row gap-3">
                ...
                <span className="hover:text-accent cursor-pointer" onClick={()=>openLink("https://www.hotelandsparesorts.com/become-partner")}>BECOME A PARTNER</span>
            </div>
            ...
            <div className="flex flex-row items-center gap-5">
                ...
                <div className="flex flex-row gap-6 items-center">
                    ...
                    {!loggedIn && <span className="hover:text-accent cursor-pointer" onClick={loginClicked}>Login</span>}
                    {loggedIn && <span className="hover:text-accent cursor-pointer" onClick={myAccountClicked}>My Account</span>}
                    {loggedIn && <span className="hover:text-accent cursor-pointer" onClick={logoutClicked}>Logout</span>}
        ...
        <div className="h-px w-full bg-primary/40" />
         ...
         <div className="w-full flex md:flex-row flex-col justify-between md:items-center items-start gap-2 mt-2 mb-5">
            ...
            <Button className="bg-accent hover:bg-accent/90 font-bold text-base px-7 py-8" onClick={()=>openLink("https://hotelandsparesorts.com/shop-gift-voucher")}>SHOP GIFT VOUCHER</Button>
