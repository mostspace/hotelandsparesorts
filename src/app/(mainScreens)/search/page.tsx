...
export default function SearchScreen() {
  ...
  return (
    <div className="w-full flex flex-col gap-[60px] py-10 text-primary bg-light items-center" >
      ...
      {!loggedIn && 
      <div className="w-full flex justify-center bg-accentDark">
      <div className="w-full flex md:flex-row gap-4 flex-col md: justify-between items-center lg:px-[11%] xl:px-[5.5%] 2xl:px-[7%] px-5 py-[40px] bg-accentDark text-light breakingPoint">
          ...
          <div className="flex flex-row gap-5 items-center">
            ...
            <span className="text-3xl max-w-100 md:max-w-1000" style={{fontFamily:'Harlow'}}>Unlock exclusive discounts at thousands of top hotels</span>
          </div>
