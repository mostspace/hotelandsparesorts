      ...
      {!loggedIn && <div className="flex flex-col items-center gap-8 p-8" >
          <div className="flex flex-col items-center gap-4 " >
            <div className="flex flex-col items-center gap-4 mb-8" >
              ...
              {onLogin && !onPasswordReset && <span className="max-w-[600px] text-[24px] md:text-2xl font-medium text-center" style={{fontFamily:'Harlow'}}>Log in to your account to access exclusive member discounts and thousands of top hotels. Easily manage your bookings and check your Hotel & Spa Resorts Gift Voucher balance. Don't have an account? Register below.</span>}
